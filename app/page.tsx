...
const PRESETS = [
  { label: 'S&P 500 (SPY)', roi: 10.5, mer: 0.09, info: 'Tracks the 500 largest US companies. The most popular index fund in the world. Includes Apple, Microsoft, Amazon, Google, etc. 30-year average return ~10.5%. Extremely diversified across US large-cap. MER of 0.09% means you pay $0.90 per $1,000 invested annually. Canadian-listed alternatives: VFV or ZSP (same index, trades in CAD on TSX, same 0.09% MER). Use VFV/ZSP in your RESP to avoid USD currency conversion.' },
  { label: 'Nasdaq 100 (QQQ)', roi: 14.5, mer: 0.20, info: 'Tracks the 100 largest non-financial companies on Nasdaq. Heavy tech weighting: Apple, Microsoft, Nvidia, Meta, Google, Amazon, Tesla. Higher growth but more volatile. 30-year average ~14.5% but with bigger drawdowns (dropped 80% in 2000, 33% in 2022). MER of 0.20% means $2 per $1,000 annually. Best for long time horizons where you can ride out crashes. Canadian-listed alternative: QQC (Invesco, 0.25% MER) or ZQQ (BMO, 0.39% MER). Use QQC in your RESP to avoid USD conversion.' },
